...
const PersonalInfoForm = () => {
  ...
  const handleSave = async() => {
    ...
    try {
      const {data} = await  axios.post("https://estorerguktbasarbackend.onrender.com/profilechange",userdata,{validateStatus:false});
      console.log(data);
      if(!data.status)
      {
  ...
  const handleChangePassword = async() => {
    ...
    try {
      const {data} = await  axios.post("https://estorerguktbasarbackend.onrender.com//password",user,{validateStatus:false});
      console.log(data);
      if(!data.status)
      {
        setError(data.message);
  ...
  try {
    const response = await axios.post("https://estorerguktbasarbackend.onrender.com/uploadProfilePhoto", formData, {
      headers: {
