...
const LoginPage = ({login,setLogin}) => {
  ...
  useEffect(()=>{
    const respose=axios.get("https://estorerguktbasarbackend.onrender.com/login")
    console.log(respose);
  },[])
...
const handleFormSubmit = async (e) => {
  ...
  try {
    const {data} = await  axios.post("https://estorerguktbasarbackend.onrender.com/login",user,{validateStatus:false});
...
const handelMainEvent = async () => {
  const { data } = await axios.get("https://estorerguktbasarbackend.onrender.com/login");
