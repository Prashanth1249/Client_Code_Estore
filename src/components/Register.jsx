...
const RegisterPage = () => {
  ...
  const handleFormSubmit = async(e) => {
    ...
    try{
      const {data} = await  axios.post("https://estorerguktbasarbackend.onrender.com/register",user,{validateStatus:false});
  ...
  const handelMainEvent = async () => {
    const { data } = await axios.get("https://estorerguktbasarbackend.onrender.com/checkAuthentication");
    navigate("/login");
    console.log(data);
  }
  return (
